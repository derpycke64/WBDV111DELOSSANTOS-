    ...
    <div id="main-frame-error" class="interstitial-wrapper ">
      <div id="main-content">
        ...
        <div id="main-message">
          ...
          <!--?lit$669423930$-->
            <p><strong>jsdelivr.net</strong> took too long to respond.</p>
          

          <!--?lit$669423930$-->
            <div id="suggestions-list">
              <p><!--?lit$669423930$-->Try:</p>
              <ul class="">
                <!--?lit$669423930$--><!---->
          ...
          <div class="error-code"><!--?lit$669423930$-->ERR_CONNECTION_TIMED_OUT</div>
      ...
      <div id="buttons" class="nav-wrapper suggested-left">
        <div id="control-buttons">
          <!--?lit$669423930$-->
            <button id="reload-button" class="blue-button text-button" data-url="https://jsdelivr.net/">
              <!--?lit$669423930$-->Reload
            </button>
    ...
    <!--?lit$669423930$-->
      <div id="sub-frame-error">
        <!-- Show details when hovering over the icon, in case the details are
             hidden because they're too large. -->
        <div class="icon "></div>
        <div id="sub-frame-error-details"><strong>jsdelivr.net</strong> took too long to respond.</div>
      </div>
